...
export const T = {
  fr: {
    ...
    app: {
      ...
      deckEdit: 'Modifier la trame', deckSave: 'Enregistrer la trame', deckCancel: 'Annuler',
      deckHint: 'Une ligne = une puce. Vos retouches sont reprises telles quelles dans l’export PowerPoint.',
      aiMapBtn: 'Faire analyser le fichier par l’IA', aiMapping: 'Analyse IA…',
      aiApplied: 'Colonnes attribuées par l’IA — vérifiez le panneau « Colonnes détectées » ci-dessous.',
      reportBtn: 'Signaler une mauvaise lecture',
      reportPrompt: 'Décrivez le problème (colonnes mal lues, valeurs erronées…) :',
      reportThanks: 'Merci ! Signalement envoyé — il alimente l’entraînement du robot de lecture.',
      reportFail: 'Envoi du signalement impossible.',
    },
    pres: {
  ...
  en: {
    ...
    app: {
      ...
      deckEdit: 'Edit the deck', deckSave: 'Save the deck', deckCancel: 'Cancel',
      deckHint: 'One line = one bullet. Your edits are used as-is in the PowerPoint export.',
      aiMapBtn: 'Let AI analyze the file', aiMapping: 'AI analysis…',
      aiApplied: 'Columns assigned by AI — check the “Columns detected” panel below.',
      reportBtn: 'Report a bad read',
      reportPrompt: 'Describe the issue (misread columns, wrong values…):',
      reportThanks: 'Thanks! Report sent — it feeds the reader’s training loop.',
      reportFail: 'Could not send the report.',
    },
    pres: {
