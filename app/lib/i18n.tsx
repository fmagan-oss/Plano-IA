...
export const T = {
  fr: {
    nav: { home: 'Accueil', offers: 'Offres', app: 'Application' },
    ...
    landing: {
      ...
      pricingTitle: 'Offres',
      pricingSub: 'Tarifs HT. Facturation B2B conforme (TVA intracommunautaire, autoliquidation UE).',
      ...
      proPlan: { ribbon: 'Le plus choisi', name: 'Pro Mensuel', price: '1 200 €', period: 'HT / mois', features: ['Tout de la Démo, plus :', '4 variantes (Équilibré / Rotation / Marge / CA)', 'Trame de présentation acheteur débloquée', 'Copilote IA connecté', 'Export & facturation B2B'], cta: 'Passer en Pro' },
      yearPlan: { name: 'Pro Annuel', price: '12 000 €', period: 'HT / an', features: ['Tout du Pro Mensuel', '2 mois offerts (vs mensuel)', 'Facture annuelle unique', 'Support prioritaire'], cta: 'Choisir l’annuel' },
  ...
  en: {
    nav: { home: 'Home', offers: 'Pricing', app: 'App' },
    ...
    landing: {
      ...
      pricingSub: 'Prices excl. VAT. Compliant B2B invoicing (EU VAT, reverse charge).',
      ...
      proPlan: { ribbon: 'Most popular', name: 'Pro Monthly', price: '€1,200', period: 'excl. VAT / month', features: ['Everything in Demo, plus:', '4 variants (Balanced / Rotation / Margin / Value)', 'Buyer presentation deck unlocked', 'Connected AI copilot', 'Export & B2B invoicing'], cta: 'Go Pro' },
      yearPlan: { name: 'Pro Yearly', price: '€12,000', period: 'excl. VAT / year', features: ['Everything in Pro Monthly', '2 months free (vs monthly)', 'Single yearly invoice', 'Priority support'], cta: 'Choose yearly' },
